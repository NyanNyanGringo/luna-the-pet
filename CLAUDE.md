...
- Python 3.11+ + FastAPI >=0.115.0, aiogram >=3.15.0, SQLAlchemy[asyncio] >=2.0.36, OpenAI SDK, APScheduler 3.x (007-extend-agent-tools)
...
## Recent Changes
- 007-extend-agent-tools: Added Python 3.11+ + FastAPI >=0.115.0, aiogram >=3.15.0, SQLAlchemy[asyncio] >=2.0.36, OpenAI SDK, APScheduler 3.x
